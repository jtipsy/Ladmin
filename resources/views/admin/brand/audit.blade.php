                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          ...
                          <th width="12%"> {{ trans('labels.brand.name') }} </th>
                          <th width="12%"> {{ trans('labels.brand.admin') }} </th>
                          <th width="20%"> {{ trans('labels.brand.enterprise') }} </th>
                          <th width="12%"> {{ trans('labels.brand.phone') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/brand/brand.js')}}"></script>
