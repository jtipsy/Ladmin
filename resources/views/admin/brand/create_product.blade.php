  ...
  <div class="col-md-12">
      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body form">
              ...
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/brand/list/create')}}">
              		{!! csrf_field() !!}
                
                  <div class="form-body">
                      <div class="form-group form-md-line-input">
                          <label class="col-md-1 control-label" for="brand_name">{{trans('labels.brand.name')}}</label>
                          <div class="col-md-3">
					  ...
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.brand_product.name')}}" value="{{old('name')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
					  <style>
					  ...
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                                <select class="bs-select form-control form-filter" data-show-subtext="true" id="species" name="species">
                                  <option value="" data-icon="fa-glass icon-success">{{trans('labels.brand_product.species')}}....</option>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <textarea name="describe" class="hide" id="content"></textarea>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-10">
                              <textarea type="text" class="form-control"  id="describe" name="describe" placeholder="{{trans('labels.brand_product.describe')}}" value="{{old('describe')}}"></textarea>
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
					  -->
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="price" name="price" placeholder="{{trans('labels.brand_product.price')}}" value="{{old('price')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>	
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                                <select class="bs-select form-control form-filter" data-show-subtext="true" id="specifications" name="specifications">
                                  <option value="" data-icon="fa-glass icon-success">{{trans('labels.brand_product.specifications')}}....</option>
					  ...
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Country_of_origin" name="Country_of_origin" placeholder="{{trans('labels.brand_product.Country_of_origin')}}" value="{{old('Country_of_origin')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  					  
                      <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                          <div class="md-checkbox-inline">
                              <div class="md-checkbox">
                                  <input type="checkbox" id="cold" name="cold" value="1" class="md-check" checked>
                                  <label for="cold">
                                      <span></span>
							  ...
							  <div class="md-checkbox">
                                  <input type="checkbox" id="empty" name="empty" value="2" class="md-check" >
                                  <label for="empty">
                                      <span></span>
                                      <span class="check"></span>
							  ...
							  <div class="md-checkbox">
                                  <input type="checkbox" id="courier" name="courier" value="3" class="md-check" >
                                  <label for="courier">
                                      <span></span>
                                      <span class="check"></span>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Shipping_agency" name="Shipping_agency" placeholder="{{trans('labels.brand_product.Shipping_agency')}}" value="{{old('Shipping_agency')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                      <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
							...
							@if(trans('strings.Selling_way'))
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="Selling_way{{config('admin.global.status.'.$status_key)}}" name="Selling_way" value="{{config('admin.global.status.'.$status_key)}}" class="md-radiobtn" @if(config('admin.global.status.'.$status_key) ==1) checked @endif>
					  ...
					  <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
							...
							@if(trans('strings.halal'))
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="halal{{config('admin.global.status.'.$status_key)}}" name="halal" value="{{config('admin.global.status.'.$status_key)}}" class="md-radiobtn" @if(config('admin.global.status.'.$status_key) ==1) checked @endif>
                      ...
                      <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
							...
							@if(trans('strings.level'))
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="level{{config('admin.global.status.'.$status_key)}}" name="level" value="{{config('admin.global.status.'.$status_key)}}" class="md-radiobtn" @if(config('admin.global.status.'.$status_key) ==1) checked @endif>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="varieties" name="varieties" placeholder="{{trans('labels.brand_product.varieties')}}" value="{{old('varieties')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>                      
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Shelf_life" name="Shelf_life" placeholder="{{trans('labels.brand_product.Shelf_life')}}" value="{{old('Shelf_life')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Storage_way" name="Storage_way" placeholder="{{trans('labels.brand_product.Storage_way')}}" value="{{old('Storage_way')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="temperature" name="temperature" placeholder="{{trans('labels.brand_product.temperature')}}" value="{{old('temperature')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="warehouse_address" name="warehouse_address" placeholder="{{trans('labels.brand_product.warehouse_address')}}" value="{{old('warehouse_address')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Production_license_number" name="Production_license_number" placeholder="{{trans('labels.brand_product.Production_license_number')}}" value="{{old('Production_license_number')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>					  
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="Production_standard_no" name="Production_standard_no" placeholder="{{trans('labels.brand_product.Production_standard_no')}}" value="{{old('Production_standard_no')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                      <div class="form-group form-md-line-input">
