        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">动态列表</span>
            </div>
            <div class="actions">
                  <div class="btn-group">
                      <a href="{{url('admin/logistics/dynamic/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th width="10%" style="min-width:50rpx;">头像</th>
                          <th width="15%"> 昵称 </th>
                          <th width="20%"> 装货地址 </th>
                          <th width="20%"> 收获地址 </th>
                          <th width="20%"> 货物名称 </th>
                              ...
                              <div class="form-group form-md-line-input">
                                  <div class="input-group has-success">
                                    <span class="input-group-addon">
                                      ...
                                      <input type="text" class="form-control form-filter" name="delivery_address" placeholder="装货地址">
                                      <div class="form-control-focus"> </div>
                                  </div>
                              </div>
                            </td>                             
                              ...
                              <div class="form-group form-md-line-input">
                                  <div class="input-group has-success">
                                    <span class="input-group-addon">
                                      ...
                                      <input type="text" class="form-control form-filter" name="shipping_address" placeholder="收货地址">
                                      <div class="form-control-focus"> </div>
                                  </div>
                              </div>
                            </td>							
                              ...
                              <div class="form-group form-md-line-input">
                                  <div class="input-group has-success">
                                    <span class="input-group-addon">
                                      ...
                                      <input type="text" class="form-control form-filter" name="shop_name" placeholder="货物名称">
                                      <div class="form-control-focus"> </div>
                                  </div>
                              </div>
                            </td>							
...
<script type="text/javascript" src="{{asset('backend/js/logistics/dynamic_list.js')}}"></script>
