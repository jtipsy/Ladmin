  ...
  <div class="col-md-12">
      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body form">
              ...
              <form role="form" class="form-horizontal" method="get" action="/admin/store/list/{{$store['id']}}/update">
					{!! csrf_field() !!}
                        ...
                        <div class="col-md-10">
                          <div class="md-checkbox-inline">
							  <div class="md-checkbox">
                                  ...
                                  <input type="hidden" value="{{$store['more1']}}" name="more1" />
                                  <label for="more1">
                                      <span></span>
							  ...
							  <div class="md-checkbox">
								  ...
								  <input type="hidden" value="{{$store['more2']}}"  name="more2" />
                                  <label for="more2">
                                      <span></span>
                                      <span class="check"></span>
