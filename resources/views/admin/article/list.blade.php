        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.article.list')}}</span>
            </div>
              <div class="actions">
                  <div class="btn-group">
                      @permission('admin.article.create')
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th width="10%"> {{ trans('labels.article.title') }} </th>
                          <th width="10%"> {{ trans('labels.article.desc') }} </th>
                          <th width="10%"> {{ trans('labels.article.author') }} </th>
                          <th width="15%"> {{ trans('labels.article.from') }} </th>
                            ...
                            <td> 
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="desc" placeholder="{{ trans('labels.article.desc') }}">
                                    <div class="form-control-focus"> </div>
                                </div>
                              </div>
                            </td>
                            <td>
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="author" placeholder="{{ trans('labels.article.author') }}">
                                    <div class="form-control-focus"> </div>
                                </div>
                              </div>
                            </td>
                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control form-filter" name="from" placeholder="{{ trans('labels.article.from') }}">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </td>
...
<script type="text/javascript" src="{{asset('backend/js/article/article.js')}}"></script>
