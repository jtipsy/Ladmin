...
<div class="page-container">
    ...
    <div class="fullwidthbanner-container slider-main banner_bg">
        <div class="banner_content">
            ...
            <div id="banner-start">
                <span id="banner-start-command">https://www.mongoliaci.com</span>
                <a id="banner-start-link" target="_blank" href="https://www.mongoliaci.com"><i class="fa fa-arrow-right"></i></a>
            </div>
        </div>
