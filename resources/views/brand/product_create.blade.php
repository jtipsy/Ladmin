...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <a href="{{url('/37fb591be38db52dd1d5f04b689008f5')}}">{!! trans('labels.breadcrumb.productList') !!}</a>
	        <i class="fa fa-angle-right"></i>
	    </li>
	    <li>
      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              @include('flash::message')
              <form role="form" class="form-horizontal" method="POST" action="{{url('/37fb591be38db52dd1d5f04b689008f4')}}">
              		{!! csrf_field() !!}
