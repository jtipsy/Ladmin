...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.storeList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.store.title')}}</span>
            </div>
	          <div class="actions">
                  <div class="btn-group">
                      <a href="{{url('/37fb591be38db52dd1d5f04b689008a2')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th width="20%" style="min-width:50rpx;"> {{ trans('labels.store.name') }} </th>
                          <th width="12%"> {{ trans('labels.store.brand_name') }} </th>
                          <th width="12%"> {{ trans('labels.store.type') }} </th>
                          <th width="12%"> {{ trans('labels.store.phone') }} </th>
						  <th width="5%">{{ trans('labels.brand.recommended') }} </th>
						  <th width="5%">{{ trans('labels.store.status') }} </th>
							...
							<td>
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="name" placeholder="{{ trans('labels.store.name') }}">
                            ...
                            <td> 
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="brand_name" placeholder="{{ trans('labels.store.brand_name') }}">
                                    <div class="form-control-focus"> </div>
                                </div>
                              </div>
                            </td>
                              ...
                              <div class="form-group form-md-line-input">
                                  <div class="input-group has-success">
                                    <span class="input-group-addon">
                                      ...
                                      <input type="text" class="form-control form-filter" name="phone" placeholder="{{ trans('labels.store.phone') }}">
                                      <div class="form-control-focus"> </div>
                                  </div>
                              </div>
                            </td>
...
<script type="text/javascript" src="{{asset('backend/js/store/webstore_list.js')}}"></script>
