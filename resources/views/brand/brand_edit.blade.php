  ...
  <div class="col-md-12">
      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body form">
              ...
              <form role="form" class="form-horizontal" method="POST" action="/37fb591be38db52dd1d5f04b689008f7/{{$brand['id']}}">
              		{!! csrf_field() !!}
                  ...
                  <div class="form-body">
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.brand.name')}}" value="{{$brand['name']}}" disabled="disabled">
					  ...
					  <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-3">
                              <input type="text" class="form-control" id="admin_name" name="admin_name" placeholder="{{trans('labels.brand.admin')}}" value="{{$brand['admin_name']}}" disabled="disabled">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
					  <style>
