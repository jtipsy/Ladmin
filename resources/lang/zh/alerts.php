...
return [
    ...
    'brand' => [
        'updated_success'   => '修改品牌成功.',
        'updated_error'     => '修改品牌失败.',
        'created_success'   => '创建品牌成功.',
        'created_error'     => '创建品牌失败.',
        'soft_deleted_success' => '删除品牌成功',
        'deleted_success'   => '彻底删除品牌成功.',
        'deleted_error'     => '彻底删除品牌失败.',
        'recomd_success'     => '推荐品牌操作成功.',
        'recomd_error'     => '推荐品牌操作失败.',
    ],    
	'product' => [
        'updated_success'   => '修改产品成功.',
        'updated_error'     => '修改产品失败.',
        'created_success'   => '创建产品成功.',
        'created_error'     => '创建产品失败.',
        'soft_deleted_success' => '删除产品成功',
        'deleted_success'   => '彻底删除产品成功.',
        'deleted_error'     => '彻底删除产品失败.',
        'recomd_success'     => '推荐产品操作成功.',
        'recomd_error'     => '推荐产品操作失败.',
    ],	
	'BrandStroe' => [
        'updated_success'   => '修改店铺成功.',
        'updated_error'     => '修改店铺失败.',
        'created_success'   => '创建店铺成功.',
        'created_error'     => '创建店铺失败.',
        'soft_deleted_success' => '删除店铺成功',
        'deleted_success'   => '彻底删除店铺成功.',
        'deleted_error'     => '彻底删除店铺失败.',
        'recomd_success'     => '推荐店铺操作成功.',
        'recomd_error'     => '推荐店铺操作失败.',
    ],
