var TableDatatablesAjax = function() {
    var datatableAjax = function(){
        ...
        ajax_datatable = dt.DataTable({
            ...
            "searching" : false,
            "ajax": {
                'url' : '/admin/logistics/dynamic',
                "data": function ( d ) {
					d.nickName = $('.filter input[name="nickName"]').val();
					d.delivery_address = $('.filter input[name="delivery_address"]').val();
					d.shipping_address = $('.filter input[name="shipping_address"]').val();
					d.shop_name = $('.filter input[name="shop_name"]').val();
